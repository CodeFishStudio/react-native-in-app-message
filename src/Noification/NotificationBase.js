...
export class NotificationBase extends React.Component {
    ...
    constructor(props) {
        ...
        NotificationBase.show = (text = null, action = () => {}) => {
            try {
                ...
                throw new Error(
                    'Unable to show Notification, because there is no instance of Notification'
                );
            }
        };
    ...
    show = () => {
        ...
        Animated.timing(this.translateY, {
            ...
            easing: Easing.bezier(0.0, 0.74, 0.2, IS_IOS ? 1.12 : 1),
        }).start(this.autohide);
    ...
    onGestureEvent = (event) => {
        ...
        this.translateY.setValue(
            translationY > 0 ? translationY / 9 : translationY / 3.5
        );
    ...
    onHandlerStateChange = (event) => {
        ...
        if (
            translationY > (this.viewHeight / 2) * -1 &&
            numberOfPointers === 0
        ) {
            this.show();
        } else {
